    ...
    <flux:sidebar.nav>
        ...
        @if($modules->has('accounting'))
            <flux:sidebar.group heading="Contabilidad" icon="calculator" expandable :expanded="request()->routeIs('admin.accounting.*')">
                ...
                <flux:sidebar.item wire:navigate.hover href="{{ route('admin.accounting.activations.index') }}" icon="clock" :data-current="request()->routeIs('admin.accounting.activations.*') ? 'true' : null">Activación histórica</flux:sidebar.item>
