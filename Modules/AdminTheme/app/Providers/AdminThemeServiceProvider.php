...
namespace Modules\AdminTheme\Providers;
...
class AdminThemeServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'AdminTheme';

    protected string $nameLower = 'admintheme';
    ...
    {
        $this->app->singleton(AdminThemePaletteService::class);
