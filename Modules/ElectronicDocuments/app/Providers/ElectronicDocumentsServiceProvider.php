...
namespace Modules\ElectronicDocuments\Providers;
...
class ElectronicDocumentsServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'ElectronicDocuments';

    protected string $nameLower = 'electronicdocuments';
