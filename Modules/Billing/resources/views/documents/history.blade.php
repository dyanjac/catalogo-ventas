...
@section('title', 'Historial de declaración del comprobante')

@section('content')
<div class="py-2">
    <div class="container-fluid">
        <x-admin.page-header :title="'Historial ' . $document->series . '-' . $document->number">
            <x-slot:actions>
                <a href="{{ route('admin.billing.documents.show', $document) }}" class="btn btn-light border rounded-pill px-4">Ver detalle</a>
                ...
                <div class="card border border-secondary rounded-3">
                    ...
                    <div class="card-body">
                        <dl class="row mb-0">
                            ...
                            <dd class="col-7">{{ strtoupper($document->status) }}</dd>
                            ...
                            <div class="border rounded-3 p-3 mb-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div>
                                        ...
                                        @else
                                            <span class="badge bg-primary ms-1">EN LINEA</span>
                                        @endif
                                    </div>
                                    <div>
                                        @if($history->ok)
                                ...
                                @else
                                    <div class="mb-2"><strong>Canal:</strong> en linea</div>
                                @endif
                                ...
                                @if($history->error_class || $history->error_message)
                                    <div class="mb-2 text-danger"><strong>Excepcion:</strong> {{ $history->error_class }} {{ $history->error_message }}</div>
                                @endif
                                <details>
