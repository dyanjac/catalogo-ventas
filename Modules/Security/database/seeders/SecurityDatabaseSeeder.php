...
class SecurityDatabaseSeeder extends Seeder
{
    ...
    private function seedModules(): array
    {
        $records = [
            ...
            ['code' => 'transport', 'name' => 'Transporte y GRE', 'status' => 'implemented', 'sort_order' => 165],
    ...
    private function seedPermissions(array $moduleMap): array
    {
        $records = [
            ...
            ['module' => 'subscriptions', 'resource' => 'contracts', 'action' => 'cancel', 'code' => 'subscriptions.contracts.cancel'],
            ['module' => 'subscriptions', 'resource' => 'contracts', 'action' => 'adjust', 'code' => 'subscriptions.contracts.adjust'],
            ...
            ['module' => 'inventory', 'resource' => 'warehouses', 'action' => 'view', 'code' => 'inventory.warehouses.view'],
            ['module' => 'inventory', 'resource' => 'warehouses', 'action' => 'update', 'code' => 'inventory.warehouses.update'],
            ...
            ['module' => 'transport', 'resource' => 'guides', 'action' => 'view', 'code' => 'transport.guides.view'],
            ['module' => 'transport', 'resource' => 'guides', 'action' => 'create', 'code' => 'transport.guides.create'],
            ['module' => 'transport', 'resource' => 'guides', 'action' => 'submit', 'code' => 'transport.guides.submit'],
            ['module' => 'transport', 'resource' => 'guides', 'action' => 'poll', 'code' => 'transport.guides.poll'],
            ['module' => 'transport', 'resource' => 'guides', 'action' => 'export', 'code' => 'transport.guides.export'],
            ['module' => 'transport', 'resource' => 'settings', 'action' => 'configure', 'code' => 'transport.settings.configure'],
    ...
    private function seedRolePermissions(array $roleMap, array $permissionMap): void
    {
        ...
        $matrix = [
            ...
            'general_manager' => ['dashboard.overview.view', 'sales.orders.view', 'sales.orders.approve', 'sales.orders.export', 'pos.sales.view', 'customers.records.view', 'catalog.products.view', 'billing.documents.view', 'billing.documents.approve', 'billing.documents.export', 'billing.documents.audit', 'accounting.entries.view', 'accounting.entries.export', 'commerce.settings.view', 'security.auth.view', 'security.roles.view', 'security.permissions.view', 'security.users.view', 'security.branches.view', 'security.branches.update', 'orders_front.orders.view', 'imports.module.view', 'finance.module.view', 'crm.module.view', 'reports.module.view', 'inventory.module.view', 'inventory.warehouses.view', 'inventory.warehouses.update', 'inventory.documents.view', 'inventory.kardex.view', 'inventory.transfers.view', 'transport.guides.view', 'warranties.module.view', 'payroll.module.view'],
            ...
            'billing_manager' => ['dashboard.overview.view', 'sales.orders.view', 'pos.sales.view', 'customers.records.view', 'catalog.products.view', 'billing.documents.view', 'billing.documents.create', 'billing.documents.update', 'billing.documents.approve', 'billing.documents.export', 'billing.documents.reprocess', 'billing.documents.audit', 'transport.guides.view', 'transport.guides.create', 'transport.guides.submit', 'transport.guides.poll', 'transport.guides.export', 'transport.settings.configure', 'accounting.entries.view', 'orders_front.orders.view', 'reports.module.view'],
            ...
            'warehouse_manager' => ['dashboard.overview.view', 'sales.orders.view', 'pos.sales.view', 'catalog.products.view', 'catalog.products.update', 'reports.module.view', 'imports.module.view', 'inventory.module.view', 'inventory.warehouses.view', 'inventory.warehouses.update', 'inventory.documents.view', 'inventory.documents.create', 'inventory.documents.confirm', 'inventory.dispatches.confirm', 'inventory.returns.confirm', 'inventory.kardex.view', 'inventory.adjustments.update', 'inventory.transfers.view', 'inventory.transfers.create', 'inventory.transfers.dispatch', 'inventory.transfers.receive', 'transport.guides.view', 'transport.guides.create', 'transport.guides.submit', 'transport.guides.poll', 'transport.guides.export', 'warranties.module.view'],
        ...
        foreach (['sales_manager', 'billing_manager'] as $roleCode) {
            $matrix[$roleCode] = array_values(array_unique([
                ...$matrix[$roleCode],
                'subscriptions.contracts.view', 'subscriptions.contracts.create',
                'subscriptions.contracts.process', 'subscriptions.contracts.cancel',
                'subscriptions.contracts.adjust',
            ]));
        }
