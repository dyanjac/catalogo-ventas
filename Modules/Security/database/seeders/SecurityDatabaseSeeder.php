...
class SecurityDatabaseSeeder extends Seeder
{
    ...
    private function seedRolePermissions(array $roleMap, array $permissionMap): void
    {
        ...
        $matrix = [
            ...
            'warehouse_manager' => ['dashboard.overview.view', 'sales.orders.view', 'pos.sales.view', 'catalog.products.view', 'catalog.products.update', 'reports.module.view', 'imports.module.view', 'inventory.module.view', 'warranties.module.view'],
