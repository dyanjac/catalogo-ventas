...
class SecurityDatabaseSeeder extends Seeder
{
    ...
    private function seedRoleModuleAccess(array $roleMap, array $moduleMap): void
    {
        $matrix = [
            ...
            'warehouse_manager' => ['dashboard' => 'readonly', 'sales' => 'readonly', 'pos' => 'readonly', 'catalog' => 'readonly', 'reports' => 'readonly', 'imports' => 'placeholder', 'inventory' => 'full', 'warranties' => 'placeholder'],
    ...
    private function seedRolePermissions(array $roleMap, array $permissionMap): void
    {
        ...
        $matrix = [
            ...
            'general_manager' => ['dashboard.overview.view', 'sales.orders.view', 'sales.orders.approve', 'sales.orders.export', 'pos.sales.view', 'customers.records.view', 'catalog.products.view', 'billing.documents.view', 'billing.documents.approve', 'billing.documents.export', 'billing.documents.audit', 'accounting.entries.view', 'accounting.entries.export', 'commerce.settings.view', 'security.auth.view', 'security.roles.view', 'security.permissions.view', 'security.users.view', 'security.branches.view', 'security.branches.update', 'orders_front.orders.view', 'imports.module.view', 'finance.module.view', 'crm.module.view', 'reports.module.view', 'inventory.module.view', 'inventory.warehouses.view', 'inventory.warehouses.update', 'inventory.documents.view', 'inventory.kardex.view', 'inventory.transfers.view', 'warranties.module.view', 'payroll.module.view'],
